...
#Last row is used to make prediction

#set filename:

#filename = 'pima-indians-diabetes.data.xlsx'
#filename = 'Wheat-price-data.xlsx'
filename = 'Wheat-price-data - up-down.xlsx'
roundto = 1
    ...
    for sheet in excel.sheets():
        ...
        for row in range(1, number_of_rows):
                ...
                try:
                    ...
                    dataset[row-1][4] = round(float(value)/roundto,0)*roundto
